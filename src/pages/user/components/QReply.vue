...
import { successMsg, warnMsg, failMsg } from '@/composables/utils'
import EventBus from '@/eventBus'
// emojis 表情符号
import { emojis } from '@/composables/emojis'
import { publishQComment } from '@/api/user/qcomment'
...
<template>
  <div class="grid grid-cols-10">
    <!-- 一级回复组件不隐藏,左侧的头像区域 -->
    <div v-if="!isChild" class="col-span-1 mt-3 text-center">
      <el-avatar :size="50" :src="arvatarUrl" @error="true">
        <img
      ...
      <el-form ref="formRef" :model="From" :rules="rules">
        <el-form-item prop="replyText">
          <el-input
            ...
            :placeholder="
              replyName ? '回复给' + replyName : '请发布友好评论...'
            "
            type="textarea"
            resize="none"
          />
