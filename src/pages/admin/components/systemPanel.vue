...
import {
  ...
  getPublishArticleStatisticsInfoLineChart
} from '@/api/admin/dashboard'
import { TransitionPresets, useTransition } from '@vueuse/core'
import ArticlePublishCalendar from '@/pages/admin/charts/ArticlePublishCalendar.vue'
import ArticleLineChart from '../charts/ArticleLineChart.vue'
...
// 近一周文章 PV 数据
const articlePublishWeekInfo = ref({})
onMounted(() => {
  ...
  getPublishArticleStatisticsInfoLineChart().then((res) => {
    if (res.success) {
      articlePublishWeekInfo.value = res.data
      console.log(res.data)
    }
  })
})

const d_articleTotalCount = useTransition(articleTotalCount, {
  duration: 1500,
  transition: TransitionPresets.easeOutExpo
})
const d_categoryTotalCount = useTransition(categoryTotalCount, {
  duration: 1500,
  transition: TransitionPresets.easeOutExpo
})
const d_tagTotalCount = useTransition(tagTotalCount, {
  duration: 1500,
  transition: TransitionPresets.easeOutExpo
})
const d_pvTotalCount = useTransition(pvTotalCount, {
  duration: 1500,
  transition: TransitionPresets.easeOutExpo
})
</script>
    ...
    <div class="grid grid-cols-4 gap-7">
      ...
      <div class="col-span-4 md:col-span-1">
        ...
        >
          ...
          <div class="ml-5">
            <h2 class="mb-1">总文章数</h2>
            <div class="font-bold text-2xl">
              {{ Math.round(d_articleTotalCount) }}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-span-4 md:col-span-1">
        ...
        >
          ...
          <div class="ml-5">
            <h2 class="mb-1">总分类数</h2>
            <div class="font-bold text-2xl">
              {{ Math.round(d_categoryTotalCount) }}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-span-4 md:col-span-1">
        ...
        >
          ...
          <div class="ml-5">
            <h2 class="mb-1">总标签数</h2>
            <div class="font-bold text-2xl">
              {{ Math.round(d_tagTotalCount) }}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-span-4 md:col-span-1">
        <!-- 卡片 -->
        <div
          class="flex items-center px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg"
        >
          <svg
            t="1699866701804"
            class="icon w-10 h-10"
      ...
      <div class="col-span-4 md:col-span-2">
        ...
        >
          ...
          <ArticleLineChart :value="articlePublishWeekInfo"></ArticleLineChart>
        </div>
      </div>
    </div>
  </main>
